...
class LoginWindow:
    ...
    def __init__(self):
        ...
        self.tabview = ctk.CTkTabview(
            ...
            height=400,
            fg_color="#23272D",
            segmented_button_fg_color="#343739",
            segmented_button_selected_color="#029CFF",
            segmented_button_selected_hover_color="#1e538d"
        )
        ...
        self.signup_code = ctk.CTkEntry(
            signup_frame,
            placeholder_text="Registration Code",
            width=314,
            height=40
        )
